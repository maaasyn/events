...
const Sidebar = () => {
  return (
    <div className="fixed bottom-0 left-0 z-10 w-full bg-white xs:sticky xs:top-0 xs:max-h-screen xs:w-auto xs:bg-transparent border-t xs:border-none border-slate-400">
      <div className="xs:max-h-screen">
        <div className="flex flex-col xs:items-center md:items-baseline px-4 xs:px-0 py-2 border-b border-gray-200 xs:border-0">
          ...
          <div className="flex flex-row xs:flex-col space-y-1">
            <button className="flex flex-col items-center justify-center w-full px-3 py-2 text-xs text-gray-700 hover:bg-gray-100 rounded-md md:flex-row md:items-center md:justify-start">
              <Star className="w-8 h-8 md:mr-2 md:w-4 md:h-4" />
              Recommended
            </button>
            <button className="flex flex-col items-center justify-center w-full px-3 py-2 text-xs text-gray-700 hover:bg-gray-100 rounded-md md:flex-row md:items-center md:justify-start">
              <Globe className="w-8 h-8 md:mr-2 md:w-4 md:h-4" />
              Explore
            </button>
            <button className="flex flex-col items-center justify-center w-full px-3 py-2 text-xs text-gray-700 hover:bg-gray-100 rounded-md md:flex-row md:items-center md:justify-start">
              <Heart className="w-8 h-8 md:mr-2 md:w-4 md:h-4" />
              Loved
            </button>
          </div>
        </div>
...
export default async function UserFeed() {
  ...
  return (
    <main className="md:px-4 xl:px-8 2xl:px-24 my-4 dark:text-white flex ">
      <Sidebar />
      <div>
        <SmartSearch />
